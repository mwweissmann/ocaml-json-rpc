...
(* OASIS_START *)
(* DO NOT EDIT (digest: b624b9b44335aa9d5798f4b982a4a38e) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for JSON-RPC";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "jsonrpc"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "cmdsrv.ml"})
            ];
     ...
     oasis_digest =
       Some "\209\131\202\n\142\181Z\176\131\023\225\168\203\193\027]";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
